                            ...
                            <td class="px-4 py-4 text-right relative">
                                <div class="dropdown inline-block relative">
                                    ...
                                    <div class="dropdown-menu absolute right-0 mt-2 w-48 rounded-lg shadow-xl bg-card border border-border z-50 py-1.5 hidden animate-in fade-in zoom-in duration-200">
                                        ...
                                        <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-foreground hover:bg-muted transition-colors" wire:click.prevent="openModal({{ $product->id }})">
                                            <x-lucide-pencil class="h-4 w-4 text-muted-foreground" />
                                            Edit Produk
                                        </a>
                                        <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-foreground hover:bg-muted transition-colors" wire:click.prevent="openHistoryModal({{ $product->id }})">
                                        ...
                                        <a href="{{ route('products.barcode', $product->id) }}" target="_blank" class="flex items-center gap-2 px-3 py-2 text-sm text-foreground hover:bg-muted transition-colors">
            ...
            >
                <div class="p-6 text-center">
                    ...
                    <p class="text-sm text-muted-foreground mt-2">
                        Apakah Anda yakin ingin menghapus produk ini? Data yang dihapus masih dapat dipulihkan oleh administrator.
                    </p>
                </div>
