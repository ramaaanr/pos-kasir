            ...
            <div class="lg:col-span-4 space-y-6 max-h-[calc(100vh-200px)] lg:overflow-y-auto pr-2 custom-scrollbar pb-10">
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid gap-2">
                        ...
                        ['key' => 'bonus', 'name' => 'Stok Bonus & Item Gratis', 'icon' => 'gift', 'color' => 'blue'],
                        ] as $item)
                ...
                <div class="bg-card border border-border/50 rounded-3xl shadow-sm overflow-hidden flex flex-col min-h-[550px]">
                    ...
                    <div class="p-5 border-b border-border bg-muted/10 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="p-2.5 rounded-2xl bg-primary/10 text-primary">
                                ...
                                'bonus' => ['name' => 'Laporan Stok Bonus & Item Gratis', 'icon' => 'gift'],
                                ];
                    ...
                    <div class="flex-1 overflow-x-auto overflow-y-auto custom-scrollbar p-1">
                        ...
                        <div wire:loading.remove wire:target="selectReport, startDate, endDate, gotoPage, nextPage, previousPage">
                            ...
                            <div class="p-6 space-y-8">
                                ...
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="4" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada transaksi ditemukan</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6">
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="3" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada data produk</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6">
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="4" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada data periode ini</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6">
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada riwayat pembayaran</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="4" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada data valuation</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6">
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada piutang aktif</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6">
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada data untuk periode ini</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="p-6">
                                ...
                                <table class="w-full text-xs text-left">
                                    ...
                                    <tbody class="divide-y divide-border">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada stok lama ditemukan</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            @elseif($selectedReport === 'bonus')
                            {{-- 12. BONUS REPORT VIEW --}}
                            <div class="p-6 space-y-8">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div class="p-6 rounded-[32px] bg-blue-600 text-white shadow-xl shadow-blue-500/20 relative overflow-hidden group">
                                        <div class="absolute -right-4 -bottom-4 opacity-10 group-hover:scale-125 transition-transform duration-700">
                                            <x-lucide-package-plus class="w-32 h-32" />
                                        </div>
                                        <div class="relative z-10">
                                            <span class="text-[10px] font-black uppercase tracking-[0.2em] opacity-70">Total Bonus Masuk</span>
                                            <p class="text-3xl font-black mt-2">{{ number_format($this->reportData['total_bonus_received'] ?? 0, 0) }}</p>
                                            <p class="text-[11px] font-bold mt-1 opacity-80 italic">Dari distributor (Item)</p>
                                        </div>
                                    </div>
                                    <div class="p-6 rounded-[32px] bg-emerald-600 text-white shadow-xl shadow-emerald-500/20 relative overflow-hidden group">
                                        <div class="absolute -right-4 -bottom-4 opacity-10 group-hover:scale-125 transition-transform duration-700">
                                            <x-lucide-gift class="w-32 h-32" />
                                        </div>
                                        <div class="relative z-10">
                                            <span class="text-[10px] font-black uppercase tracking-[0.2em] opacity-70">Total Bonus Keluar</span>
                                            <p class="text-3xl font-black mt-2">{{ number_format($this->reportData['total_bonus_given'] ?? 0, 0) }}</p>
                                            <p class="text-[11px] font-bold mt-1 opacity-80 italic">Diberikan ke pelanggan</p>
                                        </div>
                                    </div>
                                    <div class="p-6 rounded-[32px] bg-white border-2 border-primary/20 shadow-xl shadow-primary/5 relative overflow-hidden group">
                                        <div class="absolute -right-4 -bottom-4 opacity-5 group-hover:scale-125 transition-transform duration-700">
                                            <x-lucide-archive class="w-32 h-32 text-primary" />
                                        </div>
                                        <div class="relative z-10">
                                            <span class="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Sisa Stok Bonus</span>
                                            <p class="text-3xl font-black mt-2 text-primary">{{ number_format($this->reportData['remaining_bonus_stock'] ?? 0, 0) }}</p>
                                            <p class="text-[11px] font-black mt-1 text-primary/60 uppercase tracking-tighter">Tersedia di gudang</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center gap-2 px-1">
                                        <x-lucide-package-plus class="w-4 h-4 text-blue-600" />
                                        <h4 class="text-sm font-black uppercase tracking-widest text-foreground">Detail Batch Bonus</h4>
                                    </div>
                                    <table class="w-full text-xs text-left">
                                        <thead>
                                            <tr class="bg-muted/30 border-y border-border">
                                                <th class="px-4 py-3 font-black text-muted-foreground uppercase tracking-widest text-[9px]">Tgl Masuk</th>
                                                <th class="px-4 py-3 font-black text-muted-foreground uppercase tracking-widest text-[9px]">Produk</th>
                                                <th class="px-4 py-3 font-black text-muted-foreground uppercase tracking-widest text-[9px]">Batch</th>
                                                <th class="px-4 py-3 font-black text-muted-foreground uppercase tracking-widest text-[9px] text-right">In</th>
                                                <th class="px-4 py-3 font-black text-muted-foreground uppercase tracking-widest text-[9px] text-right">Sisa</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-border">
                                            @forelse(($this->reportData['batches'] ?? []) as $batch)
                                            <tr class="hover:bg-muted/10 transition-colors">
                                                <td class="px-4 py-3 text-muted-foreground">
                                                    {{ is_string($batch->tanggal_masuk) ? date('d/m/y', strtotime($batch->tanggal_masuk)) : $batch->tanggal_masuk->format('d/m/y') }}
                                                </td>
                                                <td class="px-4 py-3 font-bold text-foreground">{{ $batch->product->nama }}</td>
                                                <td class="px-4 py-3 font-mono text-primary font-bold">{{ $batch->batch_code }}</td>
                                                <td class="px-4 py-3 text-right font-medium">{{ number_format($batch->qty_masuk_base, 0) }}</td>
                                                <td class="px-4 py-3 text-right font-black text-blue-600">{{ number_format($batch->qty_sisa_base, 0) }}</td>
                                            </tr>
                                            @empty
                                            <tr>
                                                <td colspan="5" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada batch bonus ditemukan</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center gap-2 px-1">
                                        ...
                                        <h4 class="text-sm font-black uppercase tracking-widest text-foreground">Item Diberikan Gratis (Pelanggan)</h4>
                                    </div>
                                    <table class="w-full text-xs text-left">
                                        <thead>
                                            <tr class="bg-muted/30 border-y border-border">
                                        ...
                                        <tbody class="divide-y divide-border">
                                            @forelse(($this->reportData['items'] ?? []) as $item)
                                            <tr class="hover:bg-muted/10 transition-colors">
                                                <td class="px-4 py-3 text-muted-foreground">
                                                    {{ is_string($item->sale->created_at) ? date('d/m/y H:i', strtotime($item->sale->created_at)) : $item->sale->created_at->format('d/m/y H:i') }}
                                                </td>
                                                <td class="px-4 py-3 font-mono font-bold text-foreground">{{ $item->sale->invoice_number }}</td>
                                                <td class="px-4 py-3 font-bold text-emerald-700">{{ $item->product->nama }}</td>
                                                <td class="px-4 py-3 text-right font-black">{{ number_format($item->qty_base, 0) }} Unit</td>
                                            </tr>
                                            @empty
                                            <tr>
                                                <td colspan="4" class="px-4 py-10 text-center text-muted-foreground italic">Tidak ada item bonus diberikan</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
